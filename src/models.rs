...
pub struct RecallParams {
    ...
    /// When true, recall updates retrieval_count/last_accessed/decay/layer for
    /// each returned entity (the normal "I used this memory" behavior). When
    /// false, recall is a pure read and does not mutate any rows. Read-only
    /// tools such as mimir_context set this to false.
    pub bump: bool,
}
